...
#define TPM_FALSE (0)
    ...
    /* Object interface */
    TPM_C_LIB tpm_bool tpm_has_plugin_type(tpm_object_handle handle);
    TPM_C_LIB size_t tpm_get_plugin_type(tpm_object_handle handle, char* str);
    TPM_C_LIB tpm_bool tpm_has_id(tpm_object_handle handle);
    TPM_C_LIB size_t tpm_get_id(tpm_object_handle handle, char* str);
